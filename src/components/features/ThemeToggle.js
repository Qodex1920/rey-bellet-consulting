...
/**
 * Composant ThemeToggle pour basculer entre le mode clair et sombre
 * @returns {string} Markup HTML du composant
 */
const ThemeToggle = () => {
  return `
    <button 
...
/**
 * Initialise le comportement du basculeur de thème
 */

/**
 * Injecteur de bannière de consentement aux cookies
 * Ce module injecte dynamiquement le HTML du composant de consentement aux cookies
 */

"use strict";

/**
 * Fonction qui injecte le HTML du composant de consentement aux cookies dans le DOM
 */
export function injectCookieConsent() {
  // Vérifier si la bannière est déjà présente
